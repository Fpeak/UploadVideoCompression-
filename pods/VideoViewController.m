...
#define PostVideoURL @"http://v.cctv.com/flash/mp4video6/TMS/2011/01/05/cf752b1c12ce452b3040cab2f90bc265_h264818000nero_aac32-1.mp4"

@interface VideoViewController ()<ZYQAssetPickerControllerDelegate,UINavigationControllerDelegate,UpLoadImageDeletate>
...
- (IBAction)uploadVideo:(id)sender {
    ...
    if (videoMemerySize > 200) {
        ...
        dispatch_async(dispatch_get_global_queue(DISPATCH_QUEUE_PRIORITY_BACKGROUND, 0), ^{
            ...
            // 发送图片上传的请求
            [upLoadMeneger postImageWithURLString:@"上传路径"  parameter:@{@"传图的参数":@""} image:weakSelf.videoImage.image success:^(UpLoadImage *net, id object) {
